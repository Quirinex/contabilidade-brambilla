  ...
  return (
    <section className="flex flex-col items-center justify-center pt-40 pb-20 px-4 md:px-8 relative overflow-hidden bg-white">
      <div className="max-w-[1000px] w-full flex flex-col items-center text-center z-10">
        ...
        <a href="https://wa.me/554337720684" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-slate-900 to-slate-700 px-8 py-4 text-base font-medium text-white shadow-lg hover:shadow-xl hover:from-slate-800 hover:to-slate-600 transition-all duration-300">
